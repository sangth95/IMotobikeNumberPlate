[Ivy]
[>Created: Wed Sep 13 17:13:00 ICT 2017]
...
Ht0 f2 startMethod start(String,String) #txt
Ht0 f2 type axonactive.IMotobikeNumberPlateEntity #txt
Ht0 f2 requestActionDecl '<String fullName, String id> param;' #txt
...
<INSERT><Table name=''i_mobile_number_plate''/><Value column=''full_name''><AnyExpression>in.fullName</AnyExpression></Value><Value column=''user_identity''><AnyExpression>in.userIdentity</AnyExpression></Value></INSERT>' #txt
...
' #txt
Ht0 f5 464 74 256 44 -119 -8 #rect
Ht0 f5 @|DBStepIcon #fIcon
Ht0 f6 expr out #txt
Ht0 f6 344 96 464 96 #arcP
Ht0 f4 expr out #txt
Ht0 f4 720 96 825 96 #arcP
